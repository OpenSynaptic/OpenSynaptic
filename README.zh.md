...
- **触发点**：首次运行启动预检查，以及节点初始化失败后的回退路径
- **功能**：运行与 `native-build` 相同的本地构建管道，然后重试节点启动一次
...
*OpenSynaptic：batch_fused 模式，16 进程，R5 9600X。参见 [性能概览](https://opensynaptic.github.io/zh-CN/docs/reports/reports-PERFORMANCE_OPTIMIZATION_REPORT)。*
...
[完整基准报告](https://opensynaptic.github.io/docs/reports/reports-FINAL_PERFORMANCE_REPORT)
...
完整使用示例 → [`CLI README`](https://opensynaptic.github.io/docs/opensynaptic/en_GB/internal/internal-CLI_README)
...
完整 schema → [`docs/CONFIG_SCHEMA.md`](https://opensynaptic.github.io/docs/CONFIG_SCHEMA)
...
**完整测试报告**：见 [TEST_REPORT_v1.3.0.md](TEST_REPORT_v1.3.0.md) — 1275 项测试，跨 6 个套件，1273 通过，0 失败。
...
见 [`docs/TRANSPORTER_PLUGIN.md`](https://opensynaptic.github.io/docs/TRANSPORTER_PLUGIN)。

---

## API 参考

见 [`docs/API.md`](https://opensynaptic.github.io/docs/API)。

核心 API 和加载器参考 → [`docs/CORE_API.md`](https://opensynaptic.github.io/docs/CORE_API)

---

## 文档中心

- 仓库文档地图：[`docs/Navigation.md`](https://opensynaptic.github.io/docs/Navigation)
- 从这里开始：[`docs/Home.md`](https://opensynaptic.github.io/docs/Home)
- 架构详解：[`docs/ARCHITECTURE.md`](https://opensynaptic.github.io/docs/ARCHITECTURE)
- 配置 schema：[`docs/CONFIG_SCHEMA.md`](https://opensynaptic.github.io/docs/CONFIG_SCHEMA)
- 传输器/插件扩展：[`docs/TRANSPORTER_PLUGIN.md`](https://opensynaptic.github.io/docs/TRANSPORTER_PLUGIN)
- Core 内部实现：[`docs/internal/internal-PYCORE_INTERNALS.md`](https://opensynaptic.github.io/docs/internal/internal-PYCORE_INTERNALS)
- Rust 核心参考：[`docs/RSCORE_API.md`](https://opensynaptic.github.io/docs/RSCORE_API)、[`docs/PYCORE_RUST_API.md`](https://opensynaptic.github.io/docs/PYCORE_RUST_API)
- ID 租赁文档：[`docs/ID_LEASE_SYSTEM.md`](https://opensynaptic.github.io/docs/ID_LEASE_SYSTEM)、[`docs/ID_LEASE_CONFIG_REFERENCE.md`](https://opensynaptic.github.io/docs/ID_LEASE_CONFIG_REFERENCE)
